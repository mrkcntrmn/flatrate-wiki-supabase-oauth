 ...
 *
 * Entire FlatRate observation path is feature-gated and fail-closed so
 * analytics never rolls back the canonical FoF vote.
 */
class EmitVoteActivity
{
    ...
    public function handle(object $event): void
    {
        try {
            ...
            $this->logger->warning('flatrate_activity_vote_observer_failed', [
                'error_class' => $e::class,
            ]);
        }
    }
