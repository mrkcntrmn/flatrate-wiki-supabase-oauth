...
Tranche: **001A**  
Status: **R2 SOURCE ON LIVE LINEAGE / NOT PRODUCTION**  
...
| API `flatRateMemberNumber` | exposed to guests | omitted (fail-closed for null actor) | SerializeMemberProfile guest/null gate |
...
## R2 privacy refinements (2026-09-18)

```text
NULL_ACTOR_MEMBER_NUMBER_EXPOSURE=false
GUEST_MEMBER_NUMBER_EXPOSURE=false
GUEST_AFFILIATED_BRAND_PRESENTATION=false
CACHE_ISOLATION=production acceptance gate
LIVE_BASE_SHA=1b1019728ca8e85a97ed440cc44fe536ef8ab887
HISTORICAL_SOURCE_PR=#55
HISTORICAL_SOURCE_SHA=70692d5987f548a8aa8ed1fc502666fbc8899de7
```
