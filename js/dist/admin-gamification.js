...
(function (root) {
    ...
    app.initializers.add('flatrate-wiki-admin-gamification', function () {
        ...
        AdminGamificationPage.prototype.apiPath = function () {
            if (this.tab === 'quality') {
        ...
        AdminGamificationPage.prototype.load = function () {
            var self = this;
            this.loading = true;
            this.error = null;
            var url =
        ...
        AdminGamificationPage.prototype.startPolling = function () {
            var self = this;
            this.stopPolling();
        ...
        AdminGamificationPage.prototype.stopPolling = function () {
            if (this.pollTimer) {
        ...
        AdminGamificationPage.prototype.setTab = function (tab) {
            this.tab = tab;
            this.load();
        };

        AdminGamificationPage.prototype.setWindow = function (windowId) {
            this.window = windowId;
            this.load();
        };

        AdminGamificationPage.prototype.renderSources = function () {
        ...
        AdminGamificationPage.prototype.renderOverview = function () {
        ...
        AdminGamificationPage.prototype.renderQuality = function () {
            var data = (this.payload && this.payload.data) || {};
        ...
        AdminGamificationPage.prototype.renderSharing = function () {
            var data = (this.payload && this.payload.data) || {};
        ...
        AdminGamificationPage.prototype.renderReferrals = function () {
            var data = (this.payload && this.payload.data) || {};
            var summary = data.summary || {};
            var rows = (data.recent && data.recent.rows) || [];
            return m('div.FlatRateAdminGamify-panel', [
        ...
        AdminGamificationPage.prototype.view = function () {
            var self = this;
            var sessionUser = app.session && app.session.user;
