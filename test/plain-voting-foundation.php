...
(str_contains($forumLess, 'li:has(> .Post-controls)')
    ...
    && str_contains($forumLess, 'display: flex !important')
    && str_contains($forumLess, 'flex-wrap: nowrap')
    && str_contains($forumLess, '.item-reply')
    && str_contains($forumLess, 'left: 50%')
    && str_contains($forumLess, 'translateX(-50%)')
    && str_contains($forumLess, '.item-votes')
    && str_contains($forumLess, 'margin-left: auto')
